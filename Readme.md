...
# Parsing + Configuration Script – HKT-DC-10 - Rev. A

This **Parsing + Configuration** script is designed for the **HKT-DC-10** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – HKT-DC-10 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **HKT-DC-10** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
